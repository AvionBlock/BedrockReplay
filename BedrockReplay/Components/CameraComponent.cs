...
namespace BedrockReplay.Components
{
    public struct CameraComponent
    {
        ...
        public Matrix4X4<float> GetProjection() => Matrix4X4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(FOV), (float)WindowInstance.Window.Size.X / WindowInstance.Window.Size.Y, Near, Far);
    }
}
